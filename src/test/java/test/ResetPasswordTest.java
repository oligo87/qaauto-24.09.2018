...
public class ResetPasswordTest extends BaseTest{
    ...
    public void resetPasswordTest(){
        ...
        PasswordResetPage passwordResetPage = requestPasswordResetPage.searchRegisteredEmail("oleg.ilin.amc@gmail.com");
        Assert.assertTrue(passwordResetPage.isPageLoaded(),"page.RequestPasswordResetSubmitPage is not loaded.");
